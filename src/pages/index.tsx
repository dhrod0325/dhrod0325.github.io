        ...
        <div className="col-md-8">
          ...
          <article className="blog-post">
            ...
            <p>
              ...
              Bootstrap. Basic typography, lists, tables, images, code, and more are all supported
              as expected.
            </p>
            <hr />
            <p>
            ...
            <p>
              HTML defines a long list of available inline tags, a complete list of which can be
              found on the{' '}
            ...
            <ul>
              ...
              <li>
                ...
                <code className="language-plaintext highlighter-rouge">&lt;abbr&gt;</code>, with an
                optional <code className="language-plaintext highlighter-rouge">title</code>{' '}
              ...
              <li>
                <del>Deleted</del>
                text should use{' '}
                <code className="language-plaintext highlighter-rouge">&lt;del&gt;</code> and{' '}
              ...
              <li>
                ...
                <code className="language-plaintext highlighter-rouge">&lt;sup&gt;</code> and
                subscript <sub>text</sub> uses{' '}
          ...
          <article className="blog-post">
            ...
            <blockquote>
              <p>
                Longer quote goes here, maybe with some <strong>emphasized text</strong> in the
                middle of it.
              </p>
            </blockquote>
            <p>
